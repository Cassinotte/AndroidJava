...
public class MinhaView extends View {
    ...
    private Paint pincelPaintVermelho;
    ...
    public MinhaView(Context context, AttributeSet attrs)
    {
        ...
        //Vermelhor
        pincelPaintVermelho = new Paint();
        pincelPaintVermelho.setARGB(255,255, 0, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Desenha um circulo
        canvas.drawCircle(toPixels(getContext(), 200), toPixels(getContext(), 200), toPixels(getContext(), 50), pincelPaintVermelho);
